...
class ShowBarcodeInfo extends StatelessWidget {
  const ShowBarcodeInfo({super.key});

  @override
  Widget build(BuildContext context) {
    final ScannerController scannerController = Get.find<ScannerController>();
    final captureimage = scannerController.barcodeImage.value;
    final qrText = scannerController.barcodes.value;
                      ...
                      children: [
                        ...
                        if (captureimage != null)
                          ClipRRect(
                            ...
                            child: Image(
                              image: MemoryImage(captureimage),
